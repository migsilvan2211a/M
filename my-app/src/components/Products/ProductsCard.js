...
export default function ProductsCard({name, description, price, stock, _id, img}) {
	...
	return(
		<Card onClick={clickHandle} style={{height: "310px", cursor: "pointer"}} className="p-0 m-2 cardWidth">
			<Card.Img src={link} style={{height: "190px", objectFit: "cover"}} className=" m-0 p-0 border cardWidth "/>
