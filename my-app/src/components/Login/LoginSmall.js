...
export default function LoginSmall({login, setEmail, email, setPass, pass}) {
	return(
		<Form onSubmit={login} className="d-flex flex-column border border-black p-3 m-5">
			...
			<Link to="/register" className="m-2 linkDecor">Click here to create account</Link>
